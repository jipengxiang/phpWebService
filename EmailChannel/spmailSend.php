...
$mail->Host = "smtp.sp.edu.sg";
$mail->Port = 25; // 465 or 587
$mail->IsHTML(true);

$mail->SetFrom("anyemail@gmail.com");
$mail->Subject = "Your Gmail SMTP Mail";
$mail->Body = "<b>Hi, your first SMTP mail via SP STMP server has been received. Great Job!.. <br/><br/>by <a href='http://asif18.com'>Asif18</a></b>";
$mail->AddAddress("jipx@sp.edu.sg");
if (!$mail->Send()) {
